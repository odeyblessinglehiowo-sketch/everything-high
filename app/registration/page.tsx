    ...
    <div style={S.completeWrap}>
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
        ...
        <div style={{
          ...
          border: "1px solid #a3c99a",
          borderRadius: "12px",
          maxWidth: "400px",
          margin: "28px auto 0",
        }}>
          <p style={{ fontSize: "13px", fontWeight: 600, color: "#1a4d1a", fontFamily: "sans-serif", marginBottom: "6px" }}>
            📢 Join Our WhatsApp Group
          </p>
          <p style={{ fontSize: "12px", color: "#3d6b3d", fontFamily: "sans-serif", marginBottom: "14px", lineHeight: 1.5 }}>
            Stay updated with audition schedules, announcements, and connect with other applicants.
          </p>
          
            <a
  href="https://chat.whatsapp.com/FAeioDDKY9fH0qUVCtdVoO?s=cl&p=i&mlu=4"
  target="_blank"
